...
from tutorials.models import User, LessonRequest, Lesson, Invoice, ContactMessage
    ...
    def create_lessons(self):
        ...
        for _ in range(100):
            ...
            Lesson.objects.create(
                ...
                time=faker.time(),
                duration=choice([30, 60, 90, 120]),
                topic=choice(["Python", "JavaScript", "Machine Learning"]),
                status=choice(["Scheduled", "Cancelled"]),
            )
        self.stdout.write(self.style.SUCCESS("100 lessons created."))
