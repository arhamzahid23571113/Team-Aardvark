...
class LessonBookingFormTestCase(TestCase):
    def setUp(self):
        ...
        # Existing allocated lesson: 2024-12-20, 10:00-11:00
        ...
        # Default valid data that won't conflict with the 10:00-11:00 slot
        self.valid_data = {
            "requested_topic": "python_programming",
    ...
    def test_form_valid_with_boundary_duration_choice(self):
        ...
        for duration in boundary_durations:
            ...
            # Make sure there's no conflict by placing it on a different date/time
